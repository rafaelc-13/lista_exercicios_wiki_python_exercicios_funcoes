...
'''
import random
def embaralhador (nome):
    lista_letras = list(nome)
    random.shuffle(lista_letras)
    aleatoria = ''.join(lista_letras)
    return aleatoria.lower()

palavra = input("Vamos randomizar uma palavra: ")
palavra_nova = embaralhador(palavra)
print('Palavra nova é: ',palavra_nova)
